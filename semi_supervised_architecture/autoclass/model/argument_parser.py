...
def argparser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=1, #UPDATE!
        help='Number of KK classes')
    
    parser.add_argument(
        '--KK_classes_name',
        type=str,
        default=['Schizophrenia'], #UPDATE!
        help='KK classes names')
    
    parser.add_argument(
        '--KU_classes_name',
        type=str,
        default=['Bipolar Disorder','Psychotic Affective Type', 'Other Primary Psychotic Disorder', 'Substance Induced Psychotic Disorder', 'Secondary Psychotic Syndrome', 'Schizoaffective disorder'], #UPDATE!
        help='KK classes names')
    ...
    parser.add_argument(
        ...
        type=float, 
        default=0.5, 
        help='Weight for classifier loss')
